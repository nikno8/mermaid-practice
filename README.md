...
quadrantChart
    ...
    "Уведомления студентов" : [1,1]
    "Управление курсами администратором" : [1,1]
    "Просмотр оценок студентом" : [1,0]
    "Выставление оценок преподавателем" : [1,0]
    "Авторизация и регистрация" : [0,0]
    "Расширенные аналитические отчеты" : [0,1]
```
### Описание диаграммы
