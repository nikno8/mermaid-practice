...
journey
  ...
  section Регистрация и авторизация
    Пользователь: 5: Вводит данные для\nрегистрации/авторизации
    Система: 4: Проверяет данные\nи выдает доступ
    Пользователь: 5: Получает доступ\nк личному кабинету
  section Использование функционала
    Студент: 5: Просматривает\nкурсы и оценки
    Преподаватель: 4: Выставляет\nоценки студентам
    Администратор: 5: Управляет\nкурсами
  section Уведомления
    Система: 5: Отправляет уведомления\nстуденту о новых оценках
